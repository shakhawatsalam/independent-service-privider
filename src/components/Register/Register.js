...
const Register = () => {
    ...
    const handleFormSubmit = event => {
        ...
        const confirmPassword = event.target.Conpassword.value;
        if (password !== confirmPassword) {
            let err = 'pasword is not matched'
        } 
        ...
        <div className='d-flex justify-content-center items-center p-5 class'>
            <div className='login'>
                <form onSubmit={handleFormSubmit}>
                    ...
                    <input className='d-block p-2 w-100' type="password" name="name" id="" placeholder='Your Name' />
